...
namespace GitUI
{
    ...
    public sealed partial class FileStatusList : GitModuleControl, IFileStatusList
    {
        ...
        private void FileStatusListView_DrawItem(object sender, DrawListViewItemEventArgs e)
        {
            ...
            if (e.Item.Selected)
            {
                // e.Graphics.FillRectangle(SkinManager.SystemBrushes.Highlight, e.Bounds);
                // color = SkinManager.HighlightText;
            }
            else
            ...
            e.Graphics.DrawString(text, e.Item.ListView.Font,
			                      ...
			                      e.Bounds.Left + ImageSize, e.Bounds.Top);
        }
    ...
    public static class StatusListObserve
    {
        ...
        {
            //<EventArgs>
            // IObservable<EventPattern<object>> observe = null;
            IDisposable selectedIndexChangeSubscription = null;

            throw new NotImplementedException();
            /*
                observe Observable.FromEventPattern(
            ...
            IDisposable selectedIndexChangeSubscription =
                observe.Subscribe((e) => obj.FileStatusListView_SelectedIndexChanged());
            */
