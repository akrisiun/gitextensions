...
namespace GitUI
{
    public abstract class FormBrowse1 : GitModuleForm
    {
        public FormBrowse1(GitUICommands aCommands, string filter) : base(aCommands) { }
...
namespace GitUI.CommandsDialogs
{
    public partial class FormBrowseX // : FormBrowse // , IBrowseRepo
    {
        ...
        {
            UICommands.StartCheckoutBranch(this, null, false, null);
        }
        ...
        private void RebaseToolStripMenuItemClick(object sender, EventArgs e)
        {
            ...
            if (2 == revisions.Count)
            {
                ...
                UICommands.StartRebaseDialog2(this, from, to, null);
            }
            else
            {
                UICommands.StartRebaseDialog(this, null);
        ...
        void BranchSelectToolStripItem_Click(object sender, EventArgs e)
        {
            ...
            UICommands.StartCheckoutBranch(this, toolStripItem.Text, false, null);
        }
	    ...
	    private void FillTerminalTab()
	    {
		    ...
		    CommitInfoTabControl.Selecting += (sender, args) =>
		    {
                ...
                var helper = ConsoleHelper.Instance as ConsoleHelper;
                helper.Window = this;
                helper.UICommands = this.UICommands;
                helper.FillTerminalTab(terminal, Module as IGitModule);
