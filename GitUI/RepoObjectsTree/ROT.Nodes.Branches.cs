    ...
    public partial class RepoObjectsTree
    {
        ...
        abstract class BaseBranchNode : Node
        {
                ...
                : base(aTree, null)
            {
                ...
                string[] dirs = aFullPath.Split(PathSeparator[0]);
        ...
        sealed class BranchNode : BaseBranchNode
        {
            ...
            {
                UICommands.StartCreateBranchDialog(ParentWindow(), UICommands.Module.GetRevision("Head"));
            }

            public void Delete()
            {
                UICommands.StartDeleteBranchDialog(ParentWindow(), FullPath); // new string[] { FullPath });
            }
        ...
        class BranchPathNode : BaseBranchNode
        {
            ...
            public void DeleteAll()
            {
                ...
                UICommands.StartDeleteBranchDialog(ParentWindow(), branches.FirstOrDefault());
            }
