...
namespace System
{
    public static class StringExtensions2
    {
        ...
        public static bool IsNullOrEmpty2(this string s)
        {
            return string.IsNullOrEmpty(s);
        }


        public static string Combine2(this string left, string sep, string right)
        {
        ...
        public static string Combine2(this string left, char sep, string right)
        {
            if (left.IsNullOrEmpty())
                return right;
            else if (right.IsNullOrEmpty())
        ...
        /// </summary>
        public static string Quote2(this string s)
        {
            return s.Quote("\"");
        }
        ...
        /// </summary>
        public static string Quote2(this string s, string quotationMark)
        {
            if (s == null)
                return string.Empty;
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static string QuoteNE2(this string s)
        {
        ...
        /// </returns>
        [Pure]
        public static bool IsNullOrWhiteSpace2([CanBeNull] this string value)
        {
            return string.IsNullOrWhiteSpace(value);
        }

        /// <summary>Indicates whether the specified string is neither null, nor empty, nor has only whitespace.</summary>
        public static bool IsNotNullOrWhitespace2([CanBeNull] this string value)
        {
        ...
        public static string[] SplitLines2(this string value)
        {
