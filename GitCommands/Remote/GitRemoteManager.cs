...
namespace GitCommands.Remote
{
    ...
    public class GitRemoteManager : IGitRemoteManager
    {
        ...
        */
        ...
        public IEnumerable<GitRemote> LoadRemotes(bool loadDisabled)
        {
            ...
            if (loadDisabled)
            {
                ...
                if (gitRemotes.Any())
                {
                    ...
                    AddAll(Remotes, remotesNew.OrderBy(x => x.Name));
                }
        ...
        // gitextensions\GitExtUtils\Linq\LinqExtensions.cs
        public void AddAll<T>(IList<T> list, IEnumerable<T> elementsToAdd)
        {
        ...
        public virtual string[] GetDisabledRemotes() { return new string[] { }; }
