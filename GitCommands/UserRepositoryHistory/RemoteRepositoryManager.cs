...
namespace GitCommands.UserRepositoryHistory
{
    ...
    public sealed class RemoteRepositoryManager // : IRepositoryManager
    {
        ...
        public IList<Repository> AddAsMostRecent(string repositoryPathUrl)
        {
            ...
            return AddAsMostRecentRepository(repositoryPathUrl);
        }
        ...
        public IList<Repository> LoadHistory() // Async()
        {
            // await TaskScheduler.Default;
