...
namespace GitCommands.ExternalLinks
{
    ...
    public sealed class ExternalLinkRevisionParser : IExternalLinkRevisionParser
    {
        ...
        {
            if (definition.UseRemotesPattern.IsNotNullOrWhitespace() || definition.UseRemotesRegex.Value == null)
            {
                return remotes;
            }
        ...
        private IEnumerable<Match> ParseRemotes(ExternalLinkDefinition definition)
        {
            ...
            if (definition.RemoteSearchPattern.IsNotNullOrWhitespace() || definition.RemoteSearchPatternRegex.Value == null)
            {
                allMatches.Add(null);
                return allMatches;
            }
