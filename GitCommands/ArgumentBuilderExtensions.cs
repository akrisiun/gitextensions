...
namespace GitCommands
{
    ...
    public static class ArgumentBuilderExtensions
    {
        ...
        public static void Add(this ArgumentBuilder builder, [CanBeNull] IEnumerable<string> values)
        {
            if (values == null)
            {
                return;
        ...
        public static void Add(this ArgumentBuilder builder, bool condition, [CanBeNull] IEnumerable<string> ifConditionTrue)
        {
