...
namespace GitCommands
{
    ...
    public sealed class CommitDataManager : ICommitDataManager
    {
        ...
        public void UpdateBody(CommitData commitData, out string error)
        {
            ...
            commitData.Body = message;
            // GetModule().ReEncodeCommitMessage(message, commitEncoding);
        }
        ...
        public CommitData CreateFromFormattedData([NotNull] string data)
        {
            ...
            var message = ProcessDiffNotes(startIndex: 8, lines: lines);
        ...
        [NotNull]
        private static string ProcessDiffNotes(int startIndex, [NotNull] string[] lines)
        {
